...
location_id = "ef8801feddd0b4136ac70c3b133451e22754037d3dbef11a91234d3442a9b7e6"  # TODO
...
temp_feel_text = f"Как будто {temp_feel}c"
...
tooltip_text = str.format(
    ...
    f"{visbility_text}\tИКВ {air_quality_index}",
    f"<i>{prediction}</i>",
)
